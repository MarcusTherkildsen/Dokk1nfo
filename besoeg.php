...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="/besøg">Besøg</a></li>
    ...
    <div class="container" id="besoeg_list">
        <ul>
    ...
    <script type='text/javascript' src="/js/besoeg.js"></script><!--Needs to be after jQuery import-->
