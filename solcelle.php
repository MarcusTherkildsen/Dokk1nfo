...
<body>
    ...
    <div class="container" id="solcelle_list">
        <ul>
    ...
    <script type='text/javascript' src="/js/solcelle.js"></script><!--Needs to be after jQuery import-->
