...
<head>
    ...
    <title>Toiletter - Dokk1nfo</title>
...
<body>
    ...
    //$picture = "<img src='/img/bg.jpeg' style='width:100%' title='Søg efter et lokale ovenfor'>";
    $floor = '';
    $error = '';
    $time = date("m-d H:i:s");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" and htmlentities($_POST['setFloor'])) {
        ...
        if (file_exists($filename)) {
            ...
            append_to_file("logs/$year.log", $time . ", " . $address . ", T, " . $floor);
        }
    }
    ?>
    
        <div class="row center">
            <h2>Find toiletter</h2>
            <p class="center">
                Vælg niveau.
            </p>
